...
import 'package:weibo/pages/find_page.dart';
import 'package:weibo/pages/message_page.dart';
...
class _IndexPageState extends State<IndexPage> {
   ...
   * 获取bottomTab的颜色和文字
   */
  String getTabLabel(int curIndex) {
  ...
  Widget build(BuildContext context) {
    ...
    final List<BottomNavigationBarItem> bottomTabs = [
      BottomNavigationBarItem(icon: getTabIcon(0), label: getTabLabel(0)),
      BottomNavigationBarItem(icon: getTabIcon(1), label: getTabLabel(1)),
      BottomNavigationBarItem(icon: getTabIcon(2), label: getTabLabel(2)),
      BottomNavigationBarItem(icon: getTabIcon(3), label: getTabLabel(3)),
      BottomNavigationBarItem(icon: getTabIcon(4), label: getTabLabel(4)),
    ];
